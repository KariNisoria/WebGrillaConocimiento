...
namespace WebGrilla.Migrations
{
    ...
    [Migration("20250315233037_novena")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebGrilla.Models.Recurso", b =>
                {
                    ...
                    b.Property<string>("PerfilSeguridad")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebGrilla.Models.TipoDocumento", b =>
                {
                    b.Property<int>("IdTipoDocumento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebGrilla.Models.Recurso", b =>
                {
                    ...
                    b.HasOne("WebGrilla.Models.TipoDocumento", "TipoDocumento")
                        .WithMany("Recursos")
